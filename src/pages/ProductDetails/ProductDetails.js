  ...
  },
  {
    ...
    content: (
      <iframe
        width="560"
        height="315"
        src="https://www.youtube.com/embed/watch?v=ktWQU0mg0Xk&start_radio=1"
        title="YouTube Video"
        frameBorder="0"
        allowFullScreen
      ></iframe>
                ...
                {tab.id === "Fiche Technique" && productInfo.ficheTech ? (
                  <div>
                    ...
                    <div className="my-4 flex justify-end">
                      <button className="inline-flex items-center px-4 py-2 border border-gray-300 bg-[#6a4715] hover:bg-[#573b12] text-white font-bodyFont">

  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <p className="font-medium text-lg">
        <span className="font-normal">Category:</span> {productInfo.cat}
      </p>
      <button
        onClick={() =>
          dispatch(
        ...
        className="w-full py-4 bg-[#6a4715] hover:bg-[#573b12] duration-300 text-white text-lg font-titleFont"
      >
        Add to Cart
      </button>
      <p className="font-normal text-sm">
        <span className="text-base font-medium"> Bring back your old Glass Jar for cleaning and refilling. Need a new Glass Jar? Get one for 2 EUROs! </span>
      </p>
    </div>
  );
};
